...
namespace NumericalMethods
{
    public static class CSV_Tools
    {
        ...
        static public void list2csv(List<string> list, string path)
        {
        ...
        /// <returns></returns>
        static public List<string> csv2list(string path)
        {
            try
            {
        ...
        /// <returns></returns>
        static public double[,] csv2doubleArray(string path)
        {
            try
            {                                
                string datos = File.ReadAllText(path).Replace("\r", "");
        ...
        /// <returns></returns>
        static public double[,] csv2doubleArray(string path, int omitR, int omitC)
        {
            try
            {
                string datos = File.ReadAllText(path).Replace("\r", "");
