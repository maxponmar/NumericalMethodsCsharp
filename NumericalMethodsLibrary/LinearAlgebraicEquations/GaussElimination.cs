...
namespace NumericalMethodsLibrary.LinearAlgebraicEquations
{
    public class GaussElimination
    {
        ...
        public void Solve(Matrix matrix, double[] b, out double[] x, double tolerance = 0.001)
        {
            x = new double[b.Length];
            GaussElimination_Algorithm(matrix.Data, b, x, tolerance);
        }
