...
/* * Copyright (C) 2012-2018, Mathos Project. * All rights reserved. * * Please see the license file in the project folder, * or go to https://github.com/MathosProject/Mathos-Parser/blob/master/LICENSE.md. * 
* Please feel free to ask me directly at my email!
*  artem@artemlos.net
*/

namespace ReadFunction
{
    /// <summary>
    ...
    public class MathParser
    {
        ...
        public double Eval_function(string function, double x)
        {
